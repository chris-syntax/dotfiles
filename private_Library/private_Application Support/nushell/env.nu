...
$env.PATH = ($env.PATH | split row (char esep) | prepend $"($env.HOME)/.nodenv/shims")
$env.PATH = ($env.PATH | split row (char esep) | prepend $"($env.HOME)/.pyenv/shims")
